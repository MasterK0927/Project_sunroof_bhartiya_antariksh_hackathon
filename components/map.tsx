...
export default function Map() {
    ...
    const options = useMemo(() => ({
        mapId: "793ef8405dde11b1",  // Make sure this ID corresponds to a map style you want to use
        ...
        center: { lat: 23.4123, lng: 85.4399 },  // Coordinates for BIT Mesra
        zoom: 15,  // Adjust zoom level to fit the campus area
    }), []);
